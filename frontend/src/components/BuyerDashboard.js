                                    ...
                                    >
                                      ...
                                      <TableCell>
                                        <DropdownMenu>
                                          ...
                                          <DropdownMenuContent align="end" className="w-48">
                                            {/* Show Approve/Revised/Cancel for Quoted and Revision Requested offers */}
        ...
        <Dialog open={showMonitoringSubscription} onOpenChange={(open) => {
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {!selectedCampaign && monitoringFormData.selectedAssets.length > 0 && (
              <div className="space-y-6">
                {/* Individual Asset Monitoring Header */}
                <div className="bg-blue-50 rounded-lg p-4">
                  <h3 className="font-semibold text-lg text-gray-900 mb-2 flex items-center">
                  ...
                  <div className="text-sm text-gray-600">
                    Setting up monitoring for {monitoringFormData.selectedAssets.length} selected asset{monitoringFormData.selectedAssets.length > 1 ? 's' : ''}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <option value="basic">Basic - Photo documentation</option>
