                  ...
                  <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                          ...
                          <PopoverContent className="w-auto p-0">
                            <CalendarComponent
                              ...
                              disabled={(date) => {
                                ...
                                if (selectedAssetForOffer && (selectedAssetForOffer.status === 'Live' || selectedAssetForOffer.current_offer_status === 'PO Uploaded') && 
                        ...
                        {selectedAssetForOffer && (selectedAssetForOffer.status === 'Live' || selectedAssetForOffer.current_offer_status === 'PO Uploaded') && 
                         (selectedAssetForOffer.asset_expiry_date || selectedAssetForOffer.next_available_date) && (
                          <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="text-sm text-amber-800">
                                ...
                                <p>This asset is {selectedAssetForOffer.current_offer_status === 'PO Uploaded' ? 'waiting for live activation and will be' : 'currently'} occupied until {new Date(
                                  selectedAssetForOffer.asset_expiry_date || selectedAssetForOffer.next_available_date
